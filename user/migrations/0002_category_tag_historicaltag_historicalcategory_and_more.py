    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(verbose_name='Текст статьи')),
                ('author', models.CharField(max_length=255, verbose_name='Автор статьи')),
                ('category', models.ManyToManyField(related_name='category', to='user.category', verbose_name='Категории')),
                ('tag', models.ManyToManyField(related_name='category', to='user.tag', verbose_name='Теги')),
            ],
            options={
                'verbose_name': 'Статья',
