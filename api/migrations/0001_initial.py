    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visible', models.BooleanField(default=False, verbose_name='Показать всем')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.CharField(max_length=255, verbose_name='Автор статьи')),
                ('visible', models.BooleanField(default=False, verbose_name='Показать всем')),
                ('category', models.ManyToManyField(related_name='category', to='api.category', verbose_name='Категории')),
                ('tag', models.ManyToManyField(related_name='category', to='api.tag', verbose_name='Теги')),
            ],
            options={
                'verbose_name': 'Статья',
